...
nfa1 = fa.nfa(delta=nfa1delta, start=0, finals={1, 4})
print('nfa1 is')
print(nfa1)
print(40*'-')
...
nfa2 = fa.nfa(delta=nfa2delta, start=0, finals={2,3})
print(40*'-')
print('nfa2 is')
print(nfa2)
print(40*'-')
...
nfa3 = fa.nfa(delta=nfa3delta, start=0, finals={1,3})
print(40*'-')
print('nfa3 is')
print(nfa3)
print(40*'-')
...
nfa4 = fa.nfa(delta=nfa4delta, start=0, finals={0,1,2})
print(40*'-')
print('nfa4 is')
print(nfa4)
print(40*'-')
